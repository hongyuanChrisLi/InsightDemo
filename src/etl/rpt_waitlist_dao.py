...
class RptWaitlistDao(RptAbstrDao):
    ...
    def __base_table__(self):
        ...
        df_schdl = self.__read_df__(const.TADW_AUDIT_DIM) \
            ...
            .drop(const.AUDIT_OPERATION_ID) \
            .dropDuplicates()
        self.log_completion("df_schdl: dataframe schedule")
        ...
        self.log_completion("df_schdl: waitlist to scheduled")
        ...
        df_icm = df_as \
            ...
            .drop(const.INTERVIEW_STATUS_ID)
        self.log_completion("df_schdl: interview canceled or missed")
        ...
        self.log_completion("df_tw: total waitlisted")
        ...
        self.log_completion("df_tws: total waitlisted to scheduled")
        ...
        self.log_completion("df_twic: total number of waitlisted to interview completed")
        ...
        self.log_completion("df_twicm: total number waitlisted to interview cancelled or missed")
        ...
        self.log_completion("df_twiw: total number of waitlisted to interview withdrawn")
        ...
        self.log_completion("df_base: base data frame")
    ...
    def __full_table__(self):
        ...
        self.log_completion("df_full: full data frame")

        self.__write_df__(df_full, const.TARPT_WAITLIST_RPT)
        self.log_completion("written to TARPT_WAITLIST_RPT")
