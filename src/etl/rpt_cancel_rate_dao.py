...
class RptCancelRateDao(RptAbstrDao):
    ...
    def __base_table__(self):
        ...
        # dataframe of all interview cancel operations
        ...
        # dataframe of cancellation per day
        ...
        self.log_completion("DataFrame Daily Cancel")

        self.__write_df__(df_daily_cancel, const.TARPT_DAILY_CANCEL_RPT)
        self.log_completion("written to TARPT_DAILY_CANCEL_RPT")
