...
class RptProgramAuditDao(RptAbstrDao):
    ...
    def __cal_total_slots__(self):
        ...
        self.log_completion("df_tsp: Total Slots")
    ...
    def __cal_total_invites__(self):
        ...
        self.log_completion("df_tip: total invites of a program")
    ...
    def __cal_total_withdraw__(self):
        ...
        self.log_completion("df_twp: total withdraw of a program")

    def __cal_total_cancel__(self):
        # tcp: total cancellation of a program
        # (PROGRAM_ID, CALENDAR_SEASON_ID, TOTAL_CANCEL)
        self.df_tcp = self.df_cancel \
            .drop(const.SPECIALTY_ID) \
            .groupBy([const.PROGRAM_ID, const.CALENDAR_SEASON_ID]) \
            .agg(sf.count(const.CREATED_DATE).alias(TOTAL_CANCEL))
        self.log_completion("df_tcp:  total cancellation of a program")
    ...
    def __cal_first_invite_date__(self):
        ...
        self.df_fidp = self.df_invite \
            ...
            .persist()
        self.log_completion("df_fidp: first invite day of program")
    ...
    def __cal_first_date_invites__(self):
        ...
        self.log_completion("df_tfdip: first date invites of program")
    ...
    def __base_table__(self):
        ...
        self.log_completion("df_base: base table")
    ...
    def __full_table__(self):
        ...
        self.log_completion("df_full: full table")

        self.__write_df__(self.df_full, const.TARPT_PROGRAM_AUDIT_RPT)
        self.log_completion("written to TARPT_PROGRAM_AUDIT_RPT")
